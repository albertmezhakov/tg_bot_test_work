...
class UserAuthService:
    ...
    async def check_or_register(self, user_id: int, username: str | None, passphrase: str | None) -> tuple[bool, str | None]:
        async with self.uow:
            ...
            await self.uow.users.create(User(social_id=user_id, username=username))
